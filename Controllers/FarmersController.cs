...
namespace Agri_Connect_Platform.Controllers
{
    public class FarmersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FarmerID,FirstName,LastName,Email,Phone,Address")] Farmer farmer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FarmerID,FirstName,LastName,Email,Phone,Address")] Farmer farmer)
        {
